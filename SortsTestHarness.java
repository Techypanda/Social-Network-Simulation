...
/*
    THIS WAS ORIGINALLY SUBMITTED FOR PRAC 8
    THIS IS NOT MY CODE, IT IS A TEST HARNESS WE EDITED
*/
...
class SortsTestHarness
{
    ...
    private static void usage()
    {
        ...
        System.out.println("           z - quicksort leftpivot");
        System.out.println("           x - quicksort median");
        System.out.println("           y - quicksort threeway");
...
//                    long startTime = System.currentTimeMillis();
                    ...
                    switch (sortType)
                    {
                        ...
                        case 'z' : Sorts.quickSortLeft(A); break;
                        case 'x' : Sorts.quickSortMedian(A); break;
                        case 'y' : Sorts.quickThreeWaySort(A); break;
